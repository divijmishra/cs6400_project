...
# Load the data
filtered_1k_ratings = pd.read_csv("data/load/filtered_ratings_1k.csv")
filtered_1k_businesses = pd.read_csv("data/load/matched_businesses_1k.csv")
filtered_5k_ratings = pd.read_csv("data/load/filtered_ratings_5k.csv")
filtered_5k_businesses = pd.read_csv("data/load/matched_businesses_5k.csv")
filtered_10k_ratings = pd.read_csv("data/load/filtered_ratings_10k.csv")
filtered_10k_businesses = pd.read_csv("data/load/matched_businesses_10k.csv")
